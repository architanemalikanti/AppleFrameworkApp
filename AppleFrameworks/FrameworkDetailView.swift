...
struct FrameworkDetailView: View {
    ...
    @Binding var isShowingDetailView: Bool //it is whatever the parent class's variable is. so if this is FALSE, it wont show this view anymore.
...
#Preview {
    FrameworkDetailView(
        framework: Framework(name: "ARKit",
                              imageName: "arkit",
