...
//  AppleFrameworks
//
//  Created by Archita Nemalikanti on 6/4/25.
//

import Foundation

struct Framework: Hashable, Identifiable { //custom objects must conform to Hashable, String, Int already conform to Hashable.
    let id = UUID() //basically "let" is creating a constant non changing variable... then ID is a UUID.
    let name: String
